<script>
import Slot from './basic/Slot.vue';
export default{
  components: { Slot },
  // components: {Refs},
    ...
    methods: {
        onTekan(val) {
          alert('event dari child, menggunakan emits, dan mengirim value:' + val);
        },
    }
}
</script>
...
<router-view name="Looping"></router-view>
<router-view name="Lifecycle"></router-view>
